    ...
    <div className='space-y-6'>
          ...
          return (
            ...
            >
              ...
              <CardContent className='space-y-4'>
                  ...
                  <div className='flex items-end'>
                    <Button
                      ...
                      disabled={
                        ...
                        !(methodSettings as any)[config.fieldKey]
                      }
                      className='h-10'
                    >
                      Probar con $1000
                ...
                {methodSettings.enabled &&
                  (methodSettings as any)[config.fieldKey] > 0 && ( // eslint-disable-line @typescript-eslint/no-explicit-any
                    <div className='bg-gray-50 p-3 rounded-lg border'>
                      <p className='text-sm text-gray-600'>
                        <strong>Vista previa:</strong> Con{' '}
                        {(methodSettings as any)[config.fieldKey]}% de {}
                        {config.fieldKey === 'discountPercentage'
                          ? 'descuento'
                          : 'recargo'}
      ...
      <Card className='bg-blue-50 border-blue-200'>
        ...
        <CardContent className='text-sm text-blue-700 space-y-2'>
          <p>
            • Los descuentos y recargos se aplicarán automáticamente al
            seleccionar el método de pago
          </p>
          <p>
            • Para pagos mixtos, no se aplicarán descuentos/recargos automáticos
          </p>
          <p>
            • Los cambios se guardan automáticamente al modificar los valores
          </p>
          <p>
            • Usa el botón &ldquo;Probar&rdquo; para verificar los cálculos con
            ejemplos
          </p>
        </CardContent>
      </Card>
