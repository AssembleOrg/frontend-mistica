...
// Sesión de WhatsApp del bot: estado, QR para vincular, reiniciar y cerrar
// sesión. (Antes vivía en /dashboard/bot; ahora es una sub-pestaña de
// Reservas > Bot.)
  ...
  return (
    <div className='flex flex-col gap-5'>
      <div className='flex items-center justify-between'>
        <div>
          <h3 className='font-tan-nimbus text-lg font-bold text-[#455a54]'>Sesión de WhatsApp</h3>
          <p className='text-sm text-[#7a6e6f]'>Estado del bot, vinculación por QR y reconexión.</p>
        </div>
        <button
          type='button'
          onClick={resume}
