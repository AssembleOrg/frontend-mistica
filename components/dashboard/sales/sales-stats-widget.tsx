    ...
    <Card className="border-[var(--color-gris-claro)] bg-gradient-to-br from-white to-[var(--color-rosa-claro)]/30">
      <CardHeader className="pb-3">
        <CardTitle className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[var(--color-ciruela-oscuro)] font-tan-nimbus">Ventas de Hoy</span>
          </div>
          <Badge variant="secondary" className="bg-[var(--color-gris-claro)]/50 text-[var(--color-ciruela-oscuro)]">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 xl:grid-cols-3 gap-3">
          ...
          <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-[var(--color-gris-claro)]/50">
            ...
            <div className="min-w-0">
              <p className="text-xs text-[var(--color-verde-profundo)] font-medium font-winter-solid">Ventas</p>
              <p className="text-lg font-bold text-[var(--color-ciruela-oscuro)]">
          ...
          <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-[var(--color-gris-claro)]/50">
            ...
            <div className="min-w-0">
              <p className="text-xs text-[var(--color-verde-profundo)] font-medium font-winter-solid">Ingresos</p>
              <p className="text-sm font-bold text-[var(--color-ciruela-oscuro)] xl:text-base">
          ...
          {/* Productos vendidos */}
          <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-[var(--color-gris-claro)]/50 col-span-2 xl:col-span-1">
            <div className="p-2 bg-purple-100 rounded-full">
              <Package className="h-4 w-4 text-purple-600" />
            </div>
            <div className="min-w-0">
              <p className="text-xs text-[var(--color-verde-profundo)] font-medium font-winter-solid">Items Vendidos</p>
              <p className="text-lg font-bold text-[var(--color-ciruela-oscuro)]">
        ...
        <Button
          ...
          className="w-full bg-[var(--color-ciruela-oscuro)] hover:bg-[var(--color-ciruela-oscuro-hover)] text-white font-winter-solid"
          size="lg"
        >
        ...
        {todayStats.totalSales === 0 && (
          <div className="text-center py-4 text-[var(--color-ciruela-oscuro)]/70">
            ...
            <p className="text-sm font-winter-solid">No hay ventas registradas hoy</p>
            <p className="text-xs font-winter-solid">¡Empeza a vender para ver las estadísticas!</p>
          </div>
        )}
      </CardContent>
    </Card>
